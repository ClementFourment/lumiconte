        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection(
              ...
              content: 'Les présentes Conditions Générales d\'Utilisation ont pour objet de définir les modalités de mise à disposition et d\'utilisation de l\'application mobile Lumiconte. L\'accès et l\'utilisation de l\'application entraînent l\'acceptation expresse et sans réserve des présentes CGU par l\'utilisateur.',
              cardColor: cardColor,
            ...
            _buildSection(
              ...
              content: 'L\'application Lumiconte est destinée à un public d\'enfants, mais sa configuration, la création du compte utilisateur et la souscription aux éventuels services payants doivent obligatoirement être effectuées par un adulte majeur (parent ou représentant légal).\n\nLe titulaire du compte s\'engage à superviser l\'utilisation de l\'application par les mineurs sous sa responsabilité et se porte garant du respect des présentes conditions.',
              cardColor: cardColor,
              titleColor: accentColor,
              textColor: textColor,
            ),
            ...
            _buildSection(
              ...
              content: 'Lumiconte s\'engage à respecter la vie privée de ses utilisateurs et la confidentialité des données, conformément au Règlement Général sur la Protection des Données (RGPD). Les seules données collectées sont celles strictement nécessaires au bon fonctionnement de l\'application (création du compte parent, pseudonymes et âges des profils enfants pour adapter les lectures, statistiques de progression de lecture).\n\nAucune donnée personnelle n\'est vendue ou transmise à des tiers. Pour en savoir plus, l\'utilisateur est invité à consulter notre Politique de Confidentialité.',
              cardColor: cardColor,
              titleColor: accentColor,
              textColor: textColor,
            ),
            ...
            _buildSection(
              ...
              content: 'Lumiconte se réserve le droit de modifier les présentes CGU à tout moment afin de les adapter aux évolutions de l\'application ou de la législation. L\'utilisation continue de l\'application après modification vaut acceptation des nouvelles CGU.\n\nLes présentes conditions sont régies par le droit français. En cas de litige et à défaut d\'accord amiable, les tribunaux français seront seuls compétents.',
              cardColor: cardColor,
              titleColor: accentColor,
              textColor: textColor,
            ),
